...
var extension, extensions, mime, mimetype, _i, _len, _ref;
...
_ref = mime.extensions;
for (mimetype in _ref) {
  extensions = _ref[mimetype];
...
mime.lookup = function(path, fallback) {
  ...
  return mime.types[ext] || fallback || 'application/octet-stream';
};
