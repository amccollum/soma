...
soma.ClientContext = (function(_super) {
  ...
  function ClientContext(request, response) {
    var defaultHead, el, key, urlParsed, _i, _len;
    ...
    this.jar = new jar.Jar(this.request, this.response, ['$ecret']);
    this.head = {};
    defaultHead = [
      new Element('title'), new Element('meta', {
        charset: 'utf-8'
      }), new Element('script', {
        src: '/ender.js',
    ...
    for (_i = 0, _len = defaultHead.length; _i < _len; _i++) {
      el = defaultHead[_i];
  ...
  ClientContext.prototype.route = function(data) {
    var chunk, result, results, _i, _len,
      _this = this;
    this.data = data;
