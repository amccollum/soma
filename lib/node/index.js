...
soma.Context = (function(_super) {
  ...
  Context.prototype.build = function(body) {
    ...
    if (this.cookies.get('_csrf_token', {
      raw: true
    })) {
      this.send(html);
    } else {
      crypto.randomBytes(32, function(err, buf) {
        ...
        _this.cookies.set('_csrf_token', buf.toString('hex'), {
          raw: true
        });
  ...
  Context.prototype._readJSON = function() {
    ...
    this.request.on('end', function() {
      if (_this.request.method === 'GET' || _this.request.headers['x-csrf-token'] === _this.cookies.get('_csrf_token', {
        raw: true
      })) {
  ...
  Context.prototype._readBinary = function() {
    ...
    return this.request.on('end', function() {
      if (_this.request.headers['x-csrf-token'] === _this.cookies.get('_csrf_token', {
        raw: true
      })) {
  ...
  Context.prototype._readUrlEncoded = function() {
    ...
    this.request.on('end', function() {
      ...
      if (_this.request.method === 'GET' || _this.body._csrf === _this.cookies.get('_csrf_token', {
        raw: true
      })) {
  ...
  Context.prototype._readFormData = function() {
    ...
    formData.on('end', function() {
      if (_this.body._csrf === _this.cookies.get('_csrf_token', {
        raw: true
      })) {
        delete _this.body._csrf;
        return _this.route(data);
