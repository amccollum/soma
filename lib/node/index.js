...
soma.ClientContext = (function(_super) {
  ...
  function ClientContext(request, response, scripts) {
    ...
    ClientContext.__super__.constructor.apply(this, arguments);
  ...
  ClientContext.prototype.build = function(content) {
    var _this = this;
    this.loadChunk('/chunks/base.js', {
      content: content
    }, function(err, html) {
      if (err) {
        return this.sendError(err, html);
      }
  ...
  ClientContext.prototype.loadFile = function(url, callback) {
