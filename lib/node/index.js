...
soma.Context = (function(_super) {
  ...
  Context.prototype.inlineScripts = false;

  Context.prototype.inlineStylesheets = false;
  ...
  Context.prototype.build = function(body) {
    ...
    this.send("<!doctype html>\n<html " + (this.manifest || '') + ">\n<head>\n    " + (((function() {
      ...
      return _results;
    }).call(this)).join('\n    ')) + "\n    \n    <script>\n        soma._intialViews = " + (JSON.stringify(this.views)) + ";\n    </script>\n</head>\n<body>\n    " + body + "\n</body>\n</html>");
  };
  ...
  Context.prototype._readUrlEncoded = function() {
    ...
    this.request.on('end', function() {
      ...
      if (_this.request.method === 'GET' || _this.body._csrf === _this.cookies.get('_csrf', {
        raw: true
      })) {
  ...
  Context.prototype._readFormData = function() {
    ...
    formData.on('end', function() {
      if (_this.body._csrf === _this.cookies.get('_csrf', {
        raw: true
      })) {
        delete _this.body._csrf;
        return _this.route(data);
